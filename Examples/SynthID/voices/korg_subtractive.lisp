; Reference voice for docs/BATCH_VOICE_LOWERING_SPEC.md (v0.1 acceptance target).
; Korg-style subtractive: 2 VCOs + sub + noise, polyblep saw/pulse, SVF HP ->
; SVF LP/BP, dual gswitch ADSRs, LFO + 3 drift oscillators, tanh drive stages.
