...
public func + (lhs: Tensor, rhs: Tensor) -> Tensor {
  ...
  return Tensor(
    nodeId: nodeId, graph: lhs.graph, shape: outShape,
    requiresGrad: lhs.requiresGrad || rhs.requiresGrad)
}
...
public func + (lhs: Signal, rhs: Signal) -> Signal {
  let nodeId = lhs.graph.node(.add, [lhs.nodeId, rhs.nodeId])
  return Signal(
    nodeId: nodeId, graph: lhs.graph, requiresGrad: lhs.requiresGrad || rhs.requiresGrad)
}
...
public func + (lhs: Tensor, rhs: Signal) -> SignalTensor {
  let nodeId = lhs.graph.node(.add, [lhs.nodeId, rhs.nodeId])
  return SignalTensor(
    nodeId: nodeId, graph: lhs.graph, shape: lhs.shape,
    requiresGrad: lhs.requiresGrad || rhs.requiresGrad)
}
...
public func - (lhs: Signal, rhs: Tensor) -> SignalTensor {
  let nodeId = lhs.graph.node(.sub, [lhs.nodeId, rhs.nodeId])
  return SignalTensor(
    nodeId: nodeId, graph: lhs.graph, shape: rhs.shape,
    requiresGrad: lhs.requiresGrad || rhs.requiresGrad)
}
...
public func - (lhs: Signal, rhs: SignalTensor) -> SignalTensor {
  ...
  return SignalTensor(
    nodeId: nodeId, graph: rhs.graph, shape: rhs.shape,
    requiresGrad: lhs.requiresGrad || rhs.requiresGrad)
}
...
// Signal / SignalTensor
public func / (lhs: Signal, rhs: SignalTensor) -> SignalTensor {
  let nodeId = rhs.graph.node(.div, [lhs.nodeId, rhs.nodeId])
  return SignalTensor(
    nodeId: nodeId, graph: rhs.graph, shape: rhs.shape,
    requiresGrad: lhs.requiresGrad || rhs.requiresGrad)
}
...
public func + (lhs: SignalTensor, rhs: Float) -> SignalTensor {
  ...
  let nodeId = lhs.graph.node(.add, [lhs.nodeId, rhsNode])
  return SignalTensor(
    nodeId: nodeId, graph: lhs.graph, shape: lhs.shape, requiresGrad: lhs.requiresGrad)
}
...
// Float - SignalTensor
public func - (lhs: Float, rhs: SignalTensor) -> SignalTensor {
  let lhsNode = rhs.graph.node(.constant(lhs))
  let nodeId = rhs.graph.node(.sub, [lhsNode, rhs.nodeId])
  return SignalTensor(
    nodeId: nodeId, graph: rhs.graph, shape: rhs.shape, requiresGrad: rhs.requiresGrad)
}
