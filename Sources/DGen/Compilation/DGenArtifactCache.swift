...
extension Graph {
  ...
  public func compiledArtifactFingerprint() -> String {
    ...
    lines.append("mutableTensorCells=\(mutableTensorCells.sorted())")
    ...
    lines.append("frameAwareCellClocks=\(frameAwareCellClocks.sorted { $0.key < $1.key }.map { "\($0.key):\($0.value)" }.joined(separator: ","))")
