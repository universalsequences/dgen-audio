...
extension LazyOp {
  ...
  func emitGemm(
    ...
    b.loop(kSteps) { k in
      ...
      let aOffset = tileRow * b.intConstant(8 * K) + k * b.intConstant(8)
      ...
      let bOffset = k * b.intConstant(8 * N) + tileCol * b.intConstant(8)
    ...
    let cOffset = tileRow * b.intConstant(8 * N) + tileCol * b.intConstant(8)
