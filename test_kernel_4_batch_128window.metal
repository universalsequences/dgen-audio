// KERNEL 0
// FrameOrder: parallel
// DispatchMode: perFrameScaled(81920)
kernel void kernel_0(
  ...
  float t4927 = frameCount * 81920.0;
...
// KERNEL 1
// FrameOrder: parallel
// DispatchMode: staticThreads(81920)
kernel void kernel_1(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id >= 0 && id < (uint)(81920)) {
    int t130 = id;
    int t131 = t130 / 81920;
    uint _frameIndex = (uint)(t131);
    int t132 = t131 * 81920;
    int t133 = t130 - t132;
    float t134 = memory[199360 + t133];
    ...
    memory[363200 + t133] = t140;
    float t142 = metal::tanh(t140);
    memory[281280 + t133] = t142;
  }
  #pragma clang diagnostic pop
}
...
// KERNEL 2
// FrameOrder: parallel
// DispatchMode: gemm(tilesM: 80, tilesN: 16, depth: nil)
...
kernel void kernel_2(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    for (uint t148 = 0; t148 < 16; t148++) {
      ...
      int t151 = t148 * 8;
      int t152 = t150 + t151;
      metal::simdgroup_float8x8 t153 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t153, &memory[281280 + t152], 128);
      int t154 = t148 * 1024;
      int t155 = t154;
      int t156 = t145 * 8;
      int t157 = t155 + t156;
    ...
    int t162 = t145 * 8;
    int t163 = t161 + t162;
    metal::simdgroup_store(t147, &memory[199360 + t163], 128);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_3(
  ...
  if (id >= 0 && id < (uint)(81920)) {
    ...
    memory[445120 + t168] = t175;
    float t177 = metal::tanh(t175);
    memory[527040 + t168] = t177;
  }
  #pragma clang diagnostic pop
}
...
// KERNEL 4
// FrameOrder: parallel
// DispatchMode: gemm(tilesM: 80, tilesN: 8, depth: nil)
#include <metal_simdgroup_matrix>
kernel void kernel_4(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    for (uint t183 = 0; t183 < 16; t183++) {
      ...
      int t186 = t183 * 8;
      int t187 = t185 + t186;
      metal::simdgroup_float8x8 t188 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t188, &memory[527040 + t187], 128);
      int t189 = t183 * 512;
      int t190 = t189;
      int t191 = t180 * 8;
      int t192 = t190 + t191;
    ...
    int t197 = t180 * 8;
    int t198 = t196 + t197;
    metal::simdgroup_store(t182, &memory[199360 + t198], 64);
  }
  #pragma clang diagnostic pop
}
...
// KERNEL 5
// FrameOrder: parallel
// DispatchMode: staticThreads(40960)
kernel void kernel_5(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id >= 0 && id < (uint)(40960)) {
    int t200 = id;
    int t201 = t200 / 40960;
    uint _frameIndex = (uint)(t201);
    int t202 = t201 * 40960;
    int t203 = t200 - t202;
    float t204 = memory[199360 + t203];
    /* [1mUOp[0m(op: [38;5;51mbroadcastAccess[0m, value: empty) */
    int t205 = t203 / 64;
    int t206 = t205 * 64;
    int t207 = t203 - t206;
    ...
    memory[608960 + t203] = t210;
    float t212 = t210 * -1.0;
    memory[690880 + t203] = t212;
    float t214 = metal::exp(t212);
    float t215 = 1.0 + t214;
    memory[731840 + t203] = t215;
    float t217 = 1.0 / t215;
    memory[649920 + t203] = t217;
...
// KERNEL 6
// FrameOrder: parallel
// DispatchMode: perFrameScaled(640)
...
// KERNEL 7
// FrameOrder: parallel
// DispatchMode: staticThreads(640)
kernel void kernel_7(
  ...
  if (id >= 0 && id < (uint)(640)) {
    ...
    memory[772800 + t242] = t248;
    float t250 = t248 * -1.0;
    memory[774080 + t242] = t250;
    float t252 = metal::exp(t250);
    float t253 = 1.0 + t252;
    memory[773440 + t242] = t253;
    float t255 = 1.0 / t253;
    memory[774720 + t242] = t255;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_10(
  ...
  if (id >= 0 && id < (uint)(1)) {
    for (uint i = 0; i < frameCount; i += 1) {
      t[0*frameCount + i] = memory[51776513];
      ...
      memory[51776513] = t299;
      float t301 = t299 >= 63.0;
      if (t301) {
        float t303 = t299 - 63.0;
        memory[51776513] = t303;
      }
      if (0.0) {
        memory[51776513] = 0.0;
      }
...
kernel void kernel_11(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    /* [1mUOp[0m(op: [38;5;51mreshape[0m([10, 64, 64]), value: empty) */
    /* [1mUOp[0m(op: [38;5;51mtranspose[0m([1, 0, 2]), value: empty) */
    /* [1mUOp[0m(op: [38;5;51mreshape[0m([10, 64]), value: empty) */
    /* [1mUOp[0m(op: [38;5;51mtranspose[0m([1, 0]), value: empty) */
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_12(
  ...
  if (id >= 0 && id < (uint)(t4930)) {
    ...
    int t348 = (int)t347;
    memory[776000 + t348] = t345;
    int t350 = (int)t347;
    memory[11261760 + t350] = t345;
  }
  #pragma clang diagnostic pop
}
...
// KERNEL 13
// FrameOrder: parallel
// DispatchMode: perFrameScaled(10)
kernel void kernel_13(
  ...
  if (id >= 0 && id < (uint)(t4931)) {
    ...
    int t381 = (int)t380;
    memory[776000 + t381] = t378;
    int t383 = (int)t380;
    memory[22239040 + t383] = t378;
    ...
    float t394 = 1.0 - t393;
    float t395 = t353 * 10.0;
    float t396 = (float)t355;
    float t397 = t389 * 10.0;
    float t398 = t397 + t396;
    int t399 = (int)t398;
    float t400 = memory[27458 + t399];
    float t401 = t392 * 10.0;
    float t402 = t401 + t396;
    int t403 = (int)t402;
    float t404 = memory[27458 + t403];
    ...
    int t410 = (int)t409;
    memory[21747520 + t410] = t407;
    int t412 = (int)t409;
    memory[22075200 + t412] = t407;
    ...
    float t423 = 1.0 - t422;
    float t424 = t353 * 10.0;
    float t425 = (float)t355;
    float t426 = t418 * 10.0;
    float t427 = t426 + t425;
    int t428 = (int)t427;
    float t429 = memory[28098 + t428];
    float t430 = t421 * 10.0;
    float t431 = t430 + t425;
    int t432 = (int)t431;
    float t433 = memory[28098 + t432];
    ...
    int t439 = (int)t438;
    memory[21911360 + t439] = t436;
    int t441 = (int)t438;
    memory[22402880 + t441] = t436;
    /* [1mUOp[0m(op: [38;5;51mreshape[0m([10, 1]), value: empty) */
    /* [1mUOp[0m(op: [38;5;51mexpandView[0m([10, 64]), value: empty) */
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_14(
  ...
  if (id >= 0 && id < (uint)(t4932)) {
    ...
    int t451 = t450 * 10;
    int t452 = t451 + t447;
    float t453 = memory[22075200 + t452];
    float t454 = memory[28738 + t446];
    float t455 = t453 * t454;
    int t456 = _frameIndex;
    int t457 = t456 * 640;
    int t458 = t457 + t446;
    memory[776000 + t458] = t455;
  }
  #pragma clang diagnostic pop
}
...
// KERNEL 15
// FrameOrder: sequential
// DispatchMode: fixedWithFrameLoop(640)
kernel void kernel_15(
  ...
  if (id >= 0 && id < (uint)(640)) {
    for (uint i = 0; i < frameCount; i += 1) {
      ...
      int t462 = t461 * 640;
      int t463 = t462 + t460;
      float t464 = memory[776000 + t463];
      float t465 = (t464 * 6.25e-05);
      float t466 = memory[774720 + t460];
      ...
      memory[774720 + t460] = t474;
      int t476 = i;
      int t477 = t476 * 640;
      int t478 = t477 + t460;
      memory[22566720 + t478] = t466;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_16(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    /* loadGlobal(310) - handled in variable access */
    for (uint t480 = 0; t480 < 640; t480++) {
      int t481 = id;
      int t482 = t481 * 640;
      int t483 = t482 + t480;
      float t484 = memory[22566720 + t483];
      float t485 = t484 * 6.283185;
      float t486 = metal::sin(t485);
      int t487 = id;
      int t488 = t487 * 640;
      int t489 = t488 + t480;
      memory[776000 + t489] = t486;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    for (uint t491 = 0; t491 < 10; t491++) {
      /* [1mUOp[0m(op: [38;5;51msumAxisMarker[0m(node=91, axis=1, in=[10, 64], out=[10], inFA=true, outFA=true), value: empty) */
      float t492 = 0.0;
      int t493 = t491;
      int t494 = t493;
      int t495 = t491 - t494;
      ...
      for (uint t498 = 0; t498 < 64; t498++) {
        ...
        int t504 = t503 * 640;
        int t505 = t504 + t502;
        float t506 = memory[776000 + t505];
        int t507 = t493 * 64;
        int t508 = t507 + t498;
        int t509 = id;
        int t510 = t509 * 640;
        int t511 = t510 + t508;
        float t512 = memory[11261760 + t511];
      ...
      int t517 = t516 * 10;
      int t518 = t517 + t491;
      memory[33216320 + t518] = t492;
      int t520 = id;
      int t521 = t520 * 10;
      int t522 = t521 + t491;
      float t523 = memory[33216320 + t522];
      int t524 = id;
      int t525 = t524 * 10;
      int t526 = t525 + t491;
      float t527 = memory[22402880 + t526];
      float t528 = t523 * t527;
      int t529 = id;
      int t530 = t529 * 10;
      int t531 = t530 + t491;
      memory[21911360 + t531] = t528;
      int t533 = id;
      int t534 = t533 * 10;
      int t535 = t534 + t491;
      float t536 = memory[22239040 + t535];
      float t537 = t528 * t536;
      int t538 = id;
      int t539 = t538 * 10;
      int t540 = t539 + t491;
      memory[33052480 + t540] = t537;
      float t542 = t537 * 0.015625;
      int t543 = id;
      int t544 = t543 * 10;
      int t545 = t544 + t491;
      memory[22075200 + t545] = t542;
      /* [1mUOp[0m(op: [38;5;51mreshape[0m([10, 64]), value: empty) */
      /* [1mUOp[0m(op: [38;5;51mtranspose[0m([1, 0]), value: empty) */
      ...
      int t573 = (int)t572;
      memory[21747520 + t573] = t570;
      memory[774720 + (int)t491] = t570;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_17(
  ...
  if (id >= 0 && id < (uint)(1)) {
    for (uint i = 0; i < frameCount; i += 1) {
      t[2*frameCount + i] = memory[51776514];
...
kernel void kernel_18(
  ...
  if (id >= 0 && id < (uint)(t4933)) {
    ...
    float t606 = 1.0 - t605;
    float t607 = t594 * 10.0;
    float t608 = (float)t596;
    float t609 = t601 * 10.0;
    float t610 = t609 + t608;
    int t611 = (int)t610;
    float t612 = memory[29378 + t611];
    float t613 = t604 * 10.0;
    float t614 = t613 + t608;
    int t615 = (int)t614;
    float t616 = memory[29378 + t615];
    ...
    int t622 = (int)t621;
    memory[21747520 + t622] = t619;
    int t624 = (int)t621;
    memory[22566720 + t624] = t619;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_19(
  ...
  if (id >= 0 && id < (uint)(1)) {
    for (uint i = 0; i < frameCount; i += 1) {
      t[3*frameCount + i] = memory[51776515];
...
// KERNEL 20
// FrameOrder: parallel
// DispatchMode: perFrameScaledThreadgroup1(10)
  ...
  if (id >= 0 && id < (uint)(t4934)) {
    ...
    if (t659) {
      for (uint t661 = 0; t661 < 511; t661++) {
        float t662 = memory[193730 + (int)t661];
        scratch_2[(int)t661] = t662;
        float t664 = memory[194241 + (int)t661];
      ...
      for (uint t672 = 0; t672 < 512; t672++) {
        ...
        float t674 = memory[193218 + (int)t672];
        ...
        int t685 = t684 * 10;
        int t686 = t685 + t658;
        float t687 = memory[22075200 + t686];
      ...
      for (uint t693 = 0; t693 < 512; t693++) {
        float t694 = memory[194752 + (int)t693];
      ...
      for (uint t1026 = 0; t1026 < 512; t1026++) {
        ...
        memory[33380160 + t1029] = t1027;
        int t1031 = t670 + t1026;
        int t1032 = t1031 + 512;
        memory[33380160 + t1032] = t1028;
      }
      ...
      for (uint t1050 = 0; t1050 < 512; t1050++) {
        ...
        float t1052 = memory[193218 + (int)t1050];
        ...
        float t1065 = memory[22566720 + t1064];
      ...
      for (uint t1071 = 0; t1071 < 512; t1071++) {
        float t1072 = memory[194752 + (int)t1071];
      ...
      for (uint t1404 = 0; t1404 < 512; t1404++) {
        ...
        memory[34690880 + t1407] = t1405;
        int t1409 = t1048 + t1404;
        int t1410 = t1409 + 512;
        memory[34690880 + t1410] = t1406;
      }
      ...
      for (uint t1428 = 0; t1428 < 257; t1428++) {
        ...
        float t1430 = memory[36001600 + t1429];
        int t1431 = t1426 + t1428;
        float t1432 = memory[36330560 + t1431];
        float t1433 = t1430 - t1432;
        float t1434 = t1433 * t1433;
        float t1435 = t1427 + t1434;
        t1427 = t1435;
      }
      memory[649920 + t1425] = t1427;
    }
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_21(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    float t1443 = 0.0;
    if (t1442) {
      for (uint t1445 = 0; t1445 < 10; t1445++) {
        int t1446 = t1440 * 10;
        int t1447 = t1446 + t1445;
        float t1448 = memory[649920 + t1447];
        float t1449 = t1443 + t1448;
        t1443 = t1449;
      } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    }
    t[4*frameCount + id] = (t1443 * 0.1);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_23(
  ...
  if (id >= 0 && id < (uint)(1)) {
    for (uint i = 0; i < frameCount; i += 1) {
      t[6*frameCount + i] = memory[51776516];
  ...
  if (id >= 0 && id < (uint)(t4936)) {
    ...
    if (t1488) {
      for (uint t1490 = 0; t1490 < 1023; t1490++) {
        float t1491 = memory[196288 + (int)t1490];
        scratch_2[(int)t1490] = t1491;
        float t1493 = memory[197311 + (int)t1490];
      ...
      for (uint t1501 = 0; t1501 < 1024; t1501++) {
        ...
        float t1503 = memory[195264 + (int)t1501];
        ...
        float t1516 = memory[22075200 + t1515];
      ...
      for (uint t1522 = 0; t1522 < 1024; t1522++) {
        float t1523 = memory[198334 + (int)t1522];
      ...
      for (uint t1890 = 0; t1890 < 1024; t1890++) {
        ...
        memory[36659520 + t1893] = t1891;
        int t1895 = t1499 + t1890;
        int t1896 = t1895 + 1024;
        memory[36659520 + t1896] = t1892;
      }
      ...
      for (uint t1914 = 0; t1914 < 1024; t1914++) {
        ...
        float t1916 = memory[195264 + (int)t1914];
        ...
        float t1929 = memory[22566720 + t1928];
      ...
      for (uint t1935 = 0; t1935 < 1024; t1935++) {
        float t1936 = memory[198334 + (int)t1935];
      ...
      for (uint t2303 = 0; t2303 < 1024; t2303++) {
        ...
        memory[37970240 + t2306] = t2304;
        int t2308 = t1912 + t2303;
        int t2309 = t2308 + 1024;
        memory[37970240 + t2309] = t2305;
      }
      ...
      for (uint t2327 = 0; t2327 < 513; t2327++) {
        ...
        float t2329 = memory[39280960 + t2328];
        int t2330 = t2325 + t2327;
        float t2331 = memory[39609280 + t2330];
        float t2332 = t2329 - t2331;
        float t2333 = t2332 * t2332;
        float t2334 = t2326 + t2333;
        t2326 = t2334;
      }
      memory[774720 + t2324] = t2326;
    }
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_25(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    float t2342 = 0.0;
    if (t2341) {
      for (uint t2344 = 0; t2344 < 10; t2344++) {
        int t2345 = t2339 * 10;
        int t2346 = t2345 + t2344;
        float t2347 = memory[774720 + t2346];
        float t2348 = t2342 + t2347;
        t2342 = t2348;
      } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    }
    t[7*frameCount + id] = (t2342 * 0.1);
  }
  #pragma clang diagnostic pop
}
  ...
  if (id >= 0 && id < (uint)(t4937)) {
    ...
    if (t2365) {
      ...
      for (uint _pr2373 = 0; _pr2373 < 513; _pr2373++) {
        ...
        float t2375 = memory[39280960 + t2374];
        int t2376 = t2371 + _pr2373;
        float t2377 = memory[39609280 + t2376];
        int t2378 = t2370 + _pr2373;
        float t2379 = memory[36659520 + t2378];
        int t2380 = t2370 + _pr2373;
        int t2381 = t2380 + 1024;
        float t2382 = memory[36659520 + t2381];
        int t2383 = t2370 + _pr2373;
        float t2384 = memory[37970240 + t2383];
        int t2385 = t2370 + _pr2373;
        int t2386 = t2385 + 1024;
        float t2387 = memory[37970240 + t2386];
        float t2388 = t2375 - t2377;
        float t2389 = 2.0 * t2388;
        float t2390 = t2389 * 3.0517579e-06;
        float t2391 = t2375 - t2377;
        float t2392 = -2.0 * t2391;
        float t2393 = t2392 * 3.0517579e-06;
  ...
  if (id >= 0 && id < (uint)(t4938)) {
    ...
    if (t2433) {
      for (uint t2435 = 0; t2435 < 1023; t2435++) {
        float t2436 = memory[196288 + (int)t2435];
        scratch_2[(int)t2435] = t2436;
        float t2438 = memory[197311 + (int)t2435];
      ...
      for (uint t2813 = 0; t2813 < 1024; t2813++) {
        ...
        float t2816 = memory[195264 + (int)t2813];
        int t2817 = t2445 + t2813;
        float t2818 = t2815 * t2816;
        memory[36659520 + t2817] = t2818;
      }
      int t2821 = t2430 / 256;
      int t2822 = t2821 * 10;
      ...
      for (uint t3193 = 0; t3193 < 1024; t3193++) {
        ...
        float t3196 = memory[195264 + (int)t3193];
        int t3197 = t2825 + t3193;
        float t3198 = t3195 * t3196;
        memory[37970240 + t3197] = t3198;
      }
    }
  }
  #pragma clang diagnostic pop
...
kernel void kernel_29(
  ...
  if (id >= 0 && id < (uint)(t4939)) {
    ...
    for (uint t3219 = 0; t3219 < 5; t3219++) {
      ...
      int t3239 = (int)t3238;
      float t3240 = memory[36659520 + t3239];
...
kernel void kernel_30(
  ...
  if (id >= 0 && id < (uint)(t4940)) {
    ...
    for (uint t3265 = 0; t3265 < 5; t3265++) {
      ...
      int t3285 = (int)t3284;
      float t3286 = memory[37970240 + t3285];
  ...
  if (id >= 0 && id < (uint)(t4941)) {
    ...
    if (t3304) {
      ...
      for (uint _pr3312 = 0; _pr3312 < 257; _pr3312++) {
        ...
        float t3314 = memory[36001600 + t3313];
        int t3315 = t3310 + _pr3312;
        float t3316 = memory[36330560 + t3315];
        int t3317 = t3309 + _pr3312;
        float t3318 = memory[33380160 + t3317];
        int t3319 = t3309 + _pr3312;
        int t3320 = t3319 + 512;
        float t3321 = memory[33380160 + t3320];
        int t3322 = t3309 + _pr3312;
        float t3323 = memory[34690880 + t3322];
        int t3324 = t3309 + _pr3312;
        int t3325 = t3324 + 512;
        float t3326 = memory[34690880 + t3325];
        float t3327 = t3314 - t3316;
        float t3328 = 2.0 * t3327;
        float t3329 = t3328 * 3.0517579e-06;
        float t3330 = t3314 - t3316;
        float t3331 = -2.0 * t3330;
        float t3332 = t3331 * 3.0517579e-06;
  ...
  if (id >= 0 && id < (uint)(t4942)) {
    ...
    if (t3372) {
      for (uint t3374 = 0; t3374 < 511; t3374++) {
        float t3375 = memory[193730 + (int)t3374];
        scratch_2[(int)t3374] = t3375;
        float t3377 = memory[194241 + (int)t3374];
      ...
      for (uint t3718 = 0; t3718 < 512; t3718++) {
        ...
        float t3721 = memory[193218 + (int)t3718];
        int t3722 = t3384 + t3718;
        float t3723 = t3720 * t3721;
        memory[33380160 + t3722] = t3723;
      }
      int t3726 = t3369 / 128;
      int t3727 = t3726 * 10;
      ...
      for (uint t4064 = 0; t4064 < 512; t4064++) {
        ...
        float t4067 = memory[193218 + (int)t4064];
        int t4068 = t3730 + t4064;
        float t4069 = t4066 * t4067;
        memory[34690880 + t4068] = t4069;
      }
    }
  }
  #pragma clang diagnostic pop
...
kernel void kernel_34(
  ...
  if (id >= 0 && id < (uint)(t4943)) {
    ...
    for (uint t4090 = 0; t4090 < 5; t4090++) {
      ...
      int t4110 = (int)t4109;
      float t4111 = memory[33380160 + t4110];
...
kernel void kernel_35(
  ...
  if (id >= 0 && id < (uint)(t4944)) {
    ...
    for (uint t4136 = 0; t4136 < 5; t4136++) {
      ...
      int t4156 = (int)t4155;
      float t4157 = memory[34690880 + t4156];
...
kernel void kernel_37(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    int t4220 = id;
    memory[649920 + t4220] = t4215;
    memory[199360 + t4220] = t4219;
    float t4223 = t4220 + 16384.0;
    int t4224 = (int)t4223;
    memory[649920 + t4224] = t4218;
    float t4226 = 1.0 - t4219;
    float t4227 = t4220 * 10.0;
    for (uint _pr4228 = 0; _pr4228 < 10; _pr4228++) {
      float t4229 = (float)_pr4228;
      float t4230 = t4227 + t4229;
      int t4231 = (int)t4230;
      float t4232 = memory[36330560 + t4231];
      float t4233 = t4227 + t4229;
      float t4234 = t4232 * t4226;
      int t4235 = (int)t4233;
      memory[21747520 + t4235] = t4234;
      float t4237 = t4232 * t4219;
      int t4238 = (int)t4233;
      memory[21911360 + t4238] = t4237;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_38(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id < 640) { uint _pr4241 = id;
    int t4242 = _pr4241 / 10;
    int t4243 = t4242 * 10;
    ...
    float t4276 = t4245 * 10.0;
    float t4277 = t4276 + t4246;
    int t4278 = (int)t4277;
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[41248320 + t4278], t4247, metal::memory_order_relaxed);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_39(
  ...
  if (id >= 0 && id < (uint)(t4946)) {
    ...
    /* [1mUOp[0m(op: [38;5;51mtranspose[0m([1, 0]), value: empty) */
    /* [1mUOp[0m(op: [38;5;51mreshape[0m([640, 1]), value: empty) */
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_40(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id >= 0 && id < (uint)(1)) {
    for (uint t4285 = 0; t4285 < 640; t4285++) {
      int t4286 = t4285;
      int t4287 = t4286;
      ...
      float t4294 = memory[41248320 + t4293];
      float t4295 = memory[773440 + (int)t4285];
      float t4296 = t4294 / t4295;
      float t4297 = memory[773440 + (int)t4285];
      float t4298 = memory[773440 + (int)t4285];
      ...
      float t4309 = memory[41248320 + t4308];
      float t4310 = t4309 * -1.0;
      float t4311 = t4310 * t4300;
      float t4312 = t4296 + t4311;
      float t4313 = memory[774080 + (int)t4285];
      float t4314 = metal::exp(t4313);
      float t4315 = t4314 * t4311;
      float t4316 = -1.0 * t4315;
      memory[775360 + (int)t4285] = t4316;
      float t4318 = memory[772800 + (int)t4285];
      float t4319 = t4318 * t4315;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    for (uint t4320 = 0; t4320 < 1; t4320++) {
      /* [1mUOp[0m(op: [38;5;51msumAxisMarker[0m(node=186, axis=0, in=[640, 1], out=[1], inFA=false, outFA=false), value: empty) */
      float t4321 = 0.0;
      int t4322 = t4320;
      int t4323 = t4322;
      ...
      int t4325 = t4322;
      int t4326 = t4325;
      for (uint t4327 = 0; t4327 < 640; t4327++) {
        int t4328 = t4327;
        int t4329 = t4326 + t4328;
        float t4330 = memory[775360 + t4329];
        float t4331 = t4321 + t4330;
        t4321 = t4331;
      } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
      memory[774720 + (int)t4320] = t4321;
...
kernel void kernel_41(
  ...
  if (id >= 0 && id < (uint)(81920)) {
    int t4334 = id;
    int t4335 = t4334 / 81920;
    uint _frameIndex = (uint)(t4335);
    int t4336 = t4335 * 81920;
    int t4337 = t4334 - t4336;
    /* [1mUOp[0m(op: [38;5;51mexpandAxisMarker[0m(node=188, axis=2, in=[640, 1], out=[640, 1, 128], inFA=false, outFA=false), value: empty) */
    int t4338 = t4337 / 128;
    int t4339 = t4338 % 640;
    int t4340 = t4339 * 1;
    int t4341 = 0 + t4340;
    ...
    float t4346 = memory[775360 + t4345];
    memory[199360 + t4337] = t4346;
    int t4348 = t4337 / 128;
    int t4349 = t4348 * 128;
    ...
    float t4358 = memory[199360 + t4337];
    float t4359 = t4357 * t4358;
    memory[21747520 + t4337] = t4359;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_42(
  ...
  if (id >= 0 && id < (uint)(t4947)) {
    ...
    int t4366 = t4364 % 128;
    float t4367 = 0.0;
    for (uint t4368 = 0; t4368 < 640; t4368++) {
      int t4369 = t4368;
      int t4370 = t4369 + t4365;
      int t4371 = t4368 * 128;
      int t4372 = t4371 + t4366;
      float t4373 = memory[775360 + t4370];
      float t4374 = memory[527040 + t4372];
...
kernel void kernel_44(
  ...
  #pragma clang diagnostic ignored "-Wunused-variable"
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  float t4949 = frameCount * 640.0;
  if (id >= 0 && id < (uint)(t4949)) {
    int t4407 = id;
    int t4408 = t4407 / 640;
    uint _frameIndex = (uint)(t4408);
    int t4409 = t4408 * 640;
    int t4410 = t4407 - t4409;
    /* [1mUOp[0m(op: [38;5;51mexpandAxisMarker[0m(node=198, axis=1, in=[10], out=[10, 64], inFA=true, outFA=true), value: empty) */
    int t4411 = t4410 / 64;
    int t4412 = t4411 % 10;
    int t4413 = t4412 * 1;
    int t4414 = 0 + t4413;
...
kernel void kernel_45(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    int t4458 = id;
    memory[649920 + t4458] = t4453;
    memory[199360 + t4458] = t4457;
    float t4461 = t4458 + 16384.0;
    int t4462 = (int)t4461;
    memory[649920 + t4462] = t4456;
    float t4464 = 1.0 - t4457;
    float t4465 = t4458 * 640.0;
    for (uint _pr4466 = 0; _pr4466 < 640; _pr4466++) {
      float t4467 = (float)_pr4466;
      float t4468 = t4465 + t4467;
      int t4469 = (int)t4468;
      float t4470 = memory[41248960 + t4469];
      float t4471 = t4465 + t4467;
      float t4472 = t4470 * t4464;
      int t4473 = (int)t4471;
      memory[776000 + t4473] = t4472;
      float t4475 = t4470 * t4457;
      int t4476 = (int)t4471;
      memory[11261760 + t4476] = t4475;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_46(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id < 40960) { uint _pr4479 = id;
    int t4480 = _pr4479 / 640;
    int t4481 = t4480 * 640;
    ...
    float t4514 = t4483 * 640.0;
    float t4515 = t4514 + t4484;
    int t4516 = (int)t4515;
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[51734720 + t4516], t4485, metal::memory_order_relaxed);
  }
  #pragma clang diagnostic pop
}
...
// KERNEL 47
// FrameOrder: parallel
// DispatchMode: perFrameScaled(40960)
kernel void kernel_47(
  ...
  #pragma clang diagnostic ignored "-Wunused-variable"
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  float t4950 = frameCount * 40960.0;
  if (id >= 0 && id < (uint)(t4950)) {
    int t4519 = id;
    int t4520 = t4519 / 40960;
    uint _frameIndex = (uint)(t4520);
    int t4521 = t4520 * 40960;
    int t4522 = t4519 - t4521;
    /* [1mUOp[0m(op: [38;5;51mtranspose[0m([1, 0, 2]), value: empty) */
    /* [1mUOp[0m(op: [38;5;51mreshape[0m([640, 64]), value: empty) */
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_48(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id >= 0 && id < (uint)(1)) {
    for (uint t4523 = 0; t4523 < 40960; t4523++) {
      int t4524 = t4523 / 64;
      int t4525 = t4524 * 64;
      ...
      float t4539 = memory[51734720 + t4538];
      float t4540 = memory[731840 + (int)t4523];
      float t4541 = t4539 / t4540;
      float t4542 = memory[731840 + (int)t4523];
      float t4543 = memory[731840 + (int)t4523];
      ...
      float t4561 = memory[51734720 + t4560];
      float t4562 = t4561 * -1.0;
      float t4563 = t4562 * t4545;
      float t4564 = t4541 + t4563;
      float t4565 = memory[690880 + (int)t4523];
      float t4566 = metal::exp(t4565);
      float t4567 = t4566 * t4563;
      float t4568 = -1.0 * t4567;
      memory[649920 + (int)t4523] = t4568;
      float t4570 = memory[608960 + (int)t4523];
      float t4571 = t4570 * t4567;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    for (uint t4572 = 0; t4572 < 64; t4572++) {
      /* [1mUOp[0m(op: [38;5;51msumAxisMarker[0m(node=219, axis=0, in=[640, 64], out=[64], inFA=false, outFA=false), value: empty) */
      float t4573 = 0.0;
      int t4574 = t4572;
      int t4575 = t4574;
      ...
      int t4577 = t4574;
      int t4578 = t4577;
      for (uint t4579 = 0; t4579 < 640; t4579++) {
        int t4580 = t4579 * 64;
        int t4581 = t4578 + t4580;
        float t4582 = memory[649920 + t4581];
        float t4583 = t4573 + t4582;
        t4573 = t4583;
      } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
      memory[773440 + (int)t4572] = t4573;
...
kernel void kernel_49(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    for (uint t4590 = 0; t4590 < 8; t4590++) {
      ...
      metal::simdgroup_float8x8 t4595 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4595, &memory[649920 + t4594], 64);
      int t4596 = t4587 * 512;
      int t4597 = t4596;
      int t4598 = t4590 * 8;
    ...
    metal::simdgroup_store(t4589, &memory[199360 + t4605], 128);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_50(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    for (uint t4611 = 0; t4611 < 80; t4611++) {
      int t4612 = t4611 * 512;
      int t4613 = t4612;
      int t4614 = t4607 * 8;
      int t4615 = t4613 + t4614;
      metal::simdgroup_float8x8 t4616 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4616, &memory[649920 + t4615], 64, ulong2(0, 0), true);
      int t4617 = t4611 * 1024;
      int t4618 = t4617;
      int t4619 = t4608 * 8;
      int t4620 = t4618 + t4619;
      metal::simdgroup_float8x8 t4621 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4621, &memory[527040 + t4620], 128);
    ...
    metal::simdgroup_store(t4610, &memory[608960 + t4626], 128);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_51(
  ...
  if (id >= 0 && id < (uint)(81920)) {
    int t4628 = id;
    int t4629 = t4628 / 81920;
    uint _frameIndex = (uint)(t4629);
    int t4630 = t4629 * 81920;
    int t4631 = t4628 - t4630;
    float t4632 = memory[21747520 + t4631];
    float t4633 = memory[199360 + t4631];
    float t4634 = t4632 + t4633;
    memory[21911360 + t4631] = t4634;
    float t4636 = memory[445120 + t4631];
    float t4637 = metal::tanh(t4636);
    float t4638 = t4637 * t4637;
    float t4639 = 1.0 - t4638;
    memory[22075200 + t4631] = t4639;
    float t4641 = t4639 * t4634;
    memory[22239040 + t4631] = t4641;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_52(
  ...
  if (id >= 0 && id < (uint)(128)) {
    ...
    float t4647 = 0.0;
    for (uint t4648 = 0; t4648 < 640; t4648++) {
      int t4649 = t4648 * 128;
      int t4650 = t4649 + t4646;
      float t4651 = memory[22075200 + t4650];
      int t4652 = t4648 * 128;
      int t4653 = t4652 + t4646;
      float t4654 = memory[21911360 + t4653];
      float t4655 = t4651 * t4654;
      float t4656 = t4647 + t4655;
      t4647 = t4656;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    memory[774080 + t4646] = t4647;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_53(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    for (uint t4667 = 0; t4667 < 16; t4667++) {
      ...
      metal::simdgroup_float8x8 t4672 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4672, &memory[22239040 + t4671], 128);
    ...
    metal::simdgroup_store(t4666, &memory[199360 + t4682], 128);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_54(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    for (uint t4688 = 0; t4688 < 80; t4688++) {
      int t4689 = t4688 * 1024;
      int t4690 = t4689;
      int t4691 = t4684 * 8;
      int t4692 = t4690 + t4691;
      metal::simdgroup_float8x8 t4693 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4693, &memory[22239040 + t4692], 128, ulong2(0, 0), true);
      int t4694 = t4688 * 1024;
      int t4695 = t4694;
      int t4696 = t4685 * 8;
      int t4697 = t4695 + t4696;
      metal::simdgroup_float8x8 t4698 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4698, &memory[281280 + t4697], 128);
    ...
    metal::simdgroup_store(t4687, &memory[608960 + t4703], 128);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_55(
  ...
  if (id >= 0 && id < (uint)(81920)) {
    int t4705 = id;
    int t4706 = t4705 / 81920;
    uint _frameIndex = (uint)(t4706);
    int t4707 = t4706 * 81920;
    int t4708 = t4705 - t4707;
    float t4709 = memory[363200 + t4708];
    float t4710 = metal::tanh(t4709);
    float t4711 = t4710 * t4710;
    float t4712 = 1.0 - t4711;
    memory[21747520 + t4708] = t4712;
    float t4714 = memory[199360 + t4708];
    float t4715 = t4712 * t4714;
    memory[445120 + t4708] = t4715;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_56(
  ...
  if (id >= 0 && id < (uint)(128)) {
    ...
    float t4721 = 0.0;
    for (uint t4722 = 0; t4722 < 640; t4722++) {
      int t4723 = t4722 * 128;
      int t4724 = t4723 + t4720;
      float t4725 = memory[21747520 + t4724];
      int t4726 = t4722 * 128;
      int t4727 = t4726 + t4720;
      float t4728 = memory[199360 + t4727];
      float t4729 = t4725 * t4728;
      float t4730 = t4721 + t4729;
      t4721 = t4730;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    memory[775360 + t4720] = t4721;
  }
  #pragma clang diagnostic pop
}
...
// KERNEL 57
// FrameOrder: parallel
// DispatchMode: perFrameScaled(1920)
kernel void kernel_57(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  float t4951 = frameCount * 1920.0;
  if (id >= 0 && id < (uint)(t4951)) {
    int t4737 = id;
    int t4738 = t4737 / 1920;
    uint _frameIndex = (uint)(t4738);
    int t4739 = t4738 * 1920;
    ...
    for (uint t4744 = 0; t4744 < 128; t4744++) {
      ...
      float t4749 = memory[445120 + t4746];
...
kernel void kernel_58(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  float t4952 = frameCount * 384.0;
  if (id >= 0 && id < (uint)(t4952)) {
    int t4757 = id;
    int t4758 = t4757 / 384;
    ...
    int t4762 = t4760 % 3;
    float t4763 = 0.0;
    for (uint t4764 = 0; t4764 < 640; t4764++) {
      int t4765 = t4764 * 128;
      int t4766 = t4765 + t4761;
      int t4767 = t4764 * 3;
      int t4768 = t4767 + t4762;
      float t4769 = memory[445120 + t4766];
...
kernel void kernel_60(
  ...
  if (id < 384) { uint _pr4777 = id;
    ...
    int t4785 = (int)t4784;
    float t4786 = memory[41248320 + t4785];
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[51775680 + (int)_pr4777], t4786, metal::memory_order_relaxed);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_61(
  ...
  if (id < 128) { uint _pr4789 = id;
    ...
    int t4795 = (int)t4794;
    float t4796 = memory[775360 + t4795];
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[51776064 + (int)_pr4789], t4796, metal::memory_order_relaxed);
  }
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id < 128) { uint _pr4799 = id;
    ...
    int t4805 = (int)t4804;
    float t4806 = memory[774080 + t4805];
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[51776192 + (int)_pr4799], t4806, metal::memory_order_relaxed);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_62(
  ...
  if (id < 64) { uint _pr4809 = id;
    ...
    int t4815 = (int)t4814;
    float t4816 = memory[773440 + t4815];
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[51776320 + (int)_pr4809], t4816, metal::memory_order_relaxed);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_63(
  ...
  if (id < 128) { uint _pr4819 = id;
    ...
    int t4825 = (int)t4822;
    float t4826 = memory[772800 + t4825];
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[51776384 + (int)_pr4819], t4826, metal::memory_order_relaxed);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_64(
  ...
  if (id < 1) { uint _pr4829 = id;
    ...
    float t4835 = memory[774720 + (int)0.0];
    atomic_fetch_add_explicit((device metal::atomic<float>*)&memory[51776512 + (int)_pr4829], t4835, metal::memory_order_relaxed);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_66(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    int t4843 = t4840 * 64;
    for (uint t4844 = 0; t4844 < 64; t4844++) {
      int t4845 = t4843 + t4844;
      int t4846 = t4845 < t4842;
      if (t4846) {
        for (uint t4848 = 0; t4848 < 80; t4848++) {
          int t4849 = t4848 * 1024;
          int t4850 = t4849;
          int t4851 = t4838 * 8;
          int t4852 = t4850 + t4851;
          metal::simdgroup_float8x8 t4853 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4853, &memory[22239040 + t4852], 128, ulong2(0, 0), true);
          int t4854 = t4848 * 1024;
          int t4855 = t4854;
          int t4856 = t4839 * 8;
          int t4857 = t4855 + t4856;
          metal::simdgroup_float8x8 t4858 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4858, &memory[281280 + t4857], 128);
          metal::simdgroup_multiply_accumulate(t4841, t4853, t4858, t4841);
        } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
      }
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    int t4862 = t4840 * 16384;
    int t4863 = t4838 * 1024;
    int t4864 = t4862 + t4863;
    int t4865 = t4839 * 8;
    int t4866 = t4864 + t4865;
    metal::simdgroup_store(t4841, &memory[776000 + t4866], 128);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_67(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id < 16384) { uint _pr4868 = id;
    float t4869 = 0.0;
    for (uint t4870 = 0; t4870 < 256; t4870++) {
      int t4871 = t4870 * 16384;
      int t4872 = t4871 + _pr4868;
      float t4873 = memory[776000 + t4872];
      float t4874 = t4869 + t4873;
      t4869 = t4874;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    int t4876 = _pr4868 / 128;
    int t4877 = _pr4868 % 128;
    int t4878 = t4877 * 128;
    int t4879 = t4878 + t4876;
    memory[608960 + t4879] = t4869;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_69(
  ...
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  {
    ...
    int t4883 = gid.x;
    int t4884 = gid.z;
    metal::simdgroup_float8x8 t4885 = metal::simdgroup_float8x8(0);
    int t4886 = (int)frameCount;
    int t4887 = t4884 * 64;
    for (uint t4888 = 0; t4888 < 64; t4888++) {
      int t4889 = t4887 + t4888;
      int t4890 = t4889 < t4886;
      if (t4890) {
        for (uint t4892 = 0; t4892 < 80; t4892++) {
          int t4893 = t4892 * 512;
          int t4894 = t4893;
          int t4895 = t4882 * 8;
          int t4896 = t4894 + t4895;
          metal::simdgroup_float8x8 t4897 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4897, &memory[649920 + t4896], 64, ulong2(0, 0), true);
          int t4898 = t4892 * 1024;
          int t4899 = t4898;
          int t4900 = t4883 * 8;
          int t4901 = t4899 + t4900;
          metal::simdgroup_float8x8 t4902 = metal::simdgroup_float8x8(0); metal::simdgroup_load(t4902, &memory[527040 + t4901], 128);
          metal::simdgroup_multiply_accumulate(t4885, t4897, t4902, t4885);
        } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
      }
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    int t4906 = t4884 * 8192;
    int t4907 = t4882 * 1024;
    int t4908 = t4906 + t4907;
    int t4909 = t4883 * 8;
    int t4910 = t4908 + t4909;
    metal::simdgroup_store(t4885, &memory[776000 + t4910], 128);
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_70(
  ...
  uint i = 0; // Static block - no frame loop
  /* [1mUOp[0m(op: [38;5;201mframeCount[0m, value: empty) */
  if (id < 8192) { uint _pr4912 = id;
    float t4913 = 0.0;
    for (uint t4914 = 0; t4914 < 256; t4914++) {
      int t4915 = t4914 * 8192;
      int t4916 = t4915 + _pr4912;
      float t4917 = memory[776000 + t4916];
      float t4918 = t4913 + t4917;
      t4913 = t4918;
    } atomic_thread_fence(metal::mem_flags::mem_device, metal::memory_order_seq_cst);
    int t4920 = _pr4912 / 128;
    int t4921 = _pr4912 % 128;
    int t4922 = t4921 * 64;
    int t4923 = t4922 + t4920;
    memory[608960 + t4923] = t4913;
  }
  #pragma clang diagnostic pop
}
