...
kernel void kernel_2(
  ...
  if (id >= 0 && id < (uint)(1)) {
    for (uint t175 = 0; t175 < 3904; t175++) {
      ...
      memory[48884 + (int)t175] = t211;
      float t213 = t211 * -1.0;
      memory[52788 + (int)t175] = t213;
      float t215 = metal::exp(t213);
      float t216 = 1.0 + t215;
      memory[56692 + (int)t175] = t216;
      float t218 = 1.0 / t216;
...
kernel void kernel_3(
  ...
  if (id >= 0 && id < (uint)(1)) {
    for (uint t220 = 0; t220 < 61; t220++) {
      ...
      memory[60596 + (int)t220] = t251;
      float t253 = t251 * -1.0;
      memory[60724 + (int)t220] = t253;
      float t255 = metal::exp(t253);
      float t256 = 1.0 + t255;
      memory[60660 + (int)t220] = t256;
      float t258 = 1.0 / t256;
...
kernel void kernel_8(
  ...
  if (id >= 0 && id < (uint)(64)) {
    for (uint i = 0; i < frameCount; i += 1) {
      ...
      int t396 = t395 * 64;
      int t397 = t396 + t394;
      float t398 = memory[2158068 + t397];
...
kernel void kernel_9(
  ...
  if (id >= 0 && id < (uint)(t5725)) {
    ...
    int t429 = t428 * 64;
    int t430 = t429 + t417;
    float t431 = memory[1109492 + t430];
    float t432 = t423 * t431;
    int t433 = _frameIndex;
    int t434 = t433 * 64;
    int t435 = t434 + t417;
    memory[2158068 + t435] = t432;
  }
  #pragma clang diagnostic pop
}
...
kernel void kernel_10(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    for (uint t438 = 0; t438 < 64; t438++) {
      ...
      int t440 = t439 * 64;
      int t441 = t440 + t438;
      float t442 = memory[2158068 + t441];
...
kernel void kernel_29(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    for (uint t5097 = 0; t5097 < 61; t5097++) {
      ...
      float t5099 = memory[60660 + (int)t5097];
      float t5100 = t5098 / t5099;
      float t5101 = memory[60660 + (int)t5097];
      float t5102 = memory[60660 + (int)t5097];
      ...
      float t5109 = memory[60724 + (int)t5097];
      ...
      memory[2158068 + t5115] = t5112;
      float t5117 = memory[60596 + (int)t5097];
    ...
    for (uint t5119 = 0; t5119 < 1; t5119++) {
      ...
      for (uint t5126 = 0; t5126 < 61; t5126++) {
        ...
        float t5132 = memory[2158068 + t5131];
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    for (uint t5179 = 0; t5179 < 64; t5179++) {
      ...
      for (uint t5191 = 0; t5191 < 61; t5191++) {
        ...
        float t5196 = memory[37172 + t5195];
        float t5197 = t5191 + 0.0;
        int t5198 = id;
        int t5199 = t5198 * 61;
        float t5200 = t5199 + t5197;
        int t5201 = (int)t5200;
        float t5202 = memory[2158068 + t5201];
...
kernel void kernel_32(
  ...
  if (id >= 0 && id < (uint)(t5728)) {
    ...
    memory[2158068 + t5217] = t[24*frameCount + _frameIndex];
    int t5219 = _frameIndex;
    int t5220 = t5219 * 64;
    int t5221 = t5220 + t5215;
    float t5222 = memory[1109492 + t5221];
    int t5223 = _frameIndex;
    int t5224 = t5223 * 64;
    int t5225 = t5224 + t5215;
    float t5226 = memory[2158068 + t5225];
    ...
    float t5235 = memory[2158068 + t5234];
...
kernel void kernel_35(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    for (uint t5315 = 0; t5315 < 3904; t5315++) {
      ...
      float t5317 = memory[56692 + (int)t5315];
      float t5318 = t5316 / t5317;
      float t5319 = memory[56692 + (int)t5315];
      float t5320 = memory[56692 + (int)t5315];
      ...
      float t5327 = memory[52788 + (int)t5315];
      ...
      memory[209874484 + t5333] = t5330;
      float t5335 = memory[48884 + (int)t5315];
    ...
    for (uint t5337 = 0; t5337 < 64; t5337++) {
      ...
      for (uint t5344 = 0; t5344 < 61; t5344++) {
        ...
        float t5350 = memory[209874484 + t5349];
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    for (uint t5357 = 0; t5357 < 3904; t5357++) {
      ...
      for (uint t5369 = 0; t5369 < 64; t5369++) {
        ...
        float t5385 = memory[209874484 + t5384];
    ...
    for (uint t5393 = 0; t5393 < 4096; t5393++) {
      ...
      for (uint t5405 = 0; t5405 < 61; t5405++) {
        ...
        float t5410 = memory[37172 + t5409];
        int t5411 = t5405 * 64;
        int t5412 = t5411 + t5395;
        int t5413 = id;
        int t5414 = t5413 * 3904;
        int t5415 = t5414 + t5412;
        float t5416 = memory[209874484 + t5415];
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    ...
    for (uint t5443 = 0; t5443 < 64; t5443++) {
      ...
      for (uint t5450 = 0; t5450 < 61; t5450++) {
        ...
        float t5461 = memory[468876660 + t5460];
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    for (uint t5469 = 0; t5469 < 3904; t5469++) {
      ...
      for (uint t5481 = 0; t5481 < 64; t5481++) {
        ...
        float t5497 = memory[209874484 + t5496];
    ...
    for (uint t5505 = 0; t5505 < 4096; t5505++) {
      ...
      for (uint t5517 = 0; t5517 < 61; t5517++) {
        ...
        float t5522 = memory[33268 + t5521];
        int t5523 = t5517 * 64;
        int t5524 = t5523 + t5507;
        int t5525 = id;
        int t5526 = t5525 * 3904;
        int t5527 = t5526 + t5524;
        float t5528 = memory[209874484 + t5527];
...
kernel void kernel_39(
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    for (uint t5536 = 0; t5536 < 3904; t5536++) {
      float t5537 = memory[29364 + (int)t5536];
    ...
    for (uint t5550 = 0; t5550 < 64; t5550++) {
      ...
      for (uint t5557 = 0; t5557 < 61; t5557++) {
        ...
        float t5568 = memory[273837620 + t5567];
  ...
  if (id >= 0 && id < (uint)(frameCount)) {
    for (uint t5576 = 0; t5576 < 183; t5576++) {
      ...
      for (uint t5588 = 0; t5588 < 64; t5588++) {
        ...
        float t5604 = memory[209874484 + t5603];
    ...
    for (uint t5612 = 0; t5612 < 192; t5612++) {
      ...
      for (uint t5624 = 0; t5624 < 61; t5624++) {
        ...
        float t5635 = memory[209874484 + t5634];
...
kernel void kernel_41(
  ...
  if (id < 192) { uint _pr5643 = id;
    ...
    for (uint t5645 = 0; t5645 < 16384; t5645++) {
      ...
      float t5648 = memory[42020340 + t5647];
